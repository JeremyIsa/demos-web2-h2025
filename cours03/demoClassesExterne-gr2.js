...
// si on a un export (sans default), on utilise ceci :
import { Personne, Bidon } from './Personne.js';
...
// Pour ne pas affacter le tableau original, créer une copie (si nécessaire) avec .map()
